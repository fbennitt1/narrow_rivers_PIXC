...
#SBATCH --mem=50000 #64512  #
#SBATCH --time=10 #4320 #2880 #in minutes

#SBATCH --array=0 #2-204 # %5 means limit the runs with 5 arrays at a time
#SBATCH --output=../logs/log_2025_04_07_segment/log_%A_%a.log # job id: %A_ 
